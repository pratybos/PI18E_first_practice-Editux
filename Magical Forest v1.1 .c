...
-Added achievements
-Added levels
-Made sure player won't get achievement that already has
-Made sure player would able to buy wands if the reached certain level
-Added Player HUD function
*/
...
void main_menu() {
	...
	do {
		...
		printf("4. Check Achievements\n");
		printf("5.Check Player's Information\n");
